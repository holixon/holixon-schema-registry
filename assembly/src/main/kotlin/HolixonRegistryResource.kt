...
import io.holixon.avro.schema.registry.rest.api.SchemaApi
import io.holixon.avro.schema.registry.rest.model.AvroSchemaWithIdDto
import mu.KLogging
...
class HolixonRegistryResource(
  ...
  override fun registerSchema(body: Any): ResponseEntity<AvroSchemaWithIdDto> {
